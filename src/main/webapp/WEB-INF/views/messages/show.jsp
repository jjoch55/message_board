...
<tr>
<th>作成日時</th>
<td><fmt:formatDate value="${message.created_at}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
</tr>

<tr>
<th>更新日時</th>
<td><fmt:formatDate value="${message.updated_at}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
</tr>
</tbody>
</table>
